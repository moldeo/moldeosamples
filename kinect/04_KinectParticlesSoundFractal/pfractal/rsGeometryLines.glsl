...
*/
 ...
 float rel = 256.0 / fcols[0];

 if (position0.z!=0.0 && diff0<0.5*rel) {
 ...
 if (position1.z!=0.0 && diff1<0.5*rel) {
              //" gl_Position = pmatrix[0] * (vertex[0].position + mOri * vec4( -sx, -sy, 0.0, 0.0 ) );
   ...
   EmitVertex();
            ...
            //" gl_Position = pmatrix[0] * (vertex[0].position + mOri * vec4( sx, sy, 0.0, 0.0 ) );
 if (position2.z!=0.0  && diff2<0.5*rel) {
   ...
   EmitVertex();
            ...
            //" gl_Position = pmatrix[0] * (vertex[0].position + mOri * vec4( sx, -sy, 0.0, 0.0 ));
 if (position3.z!=0.0  && diff3<0.5*rel ) {
