...
vec4 SetParticleScale( vec4 father_scale ) {
  ...
  float radius;
	...
	vec4 medium = texture2D( src_tex_unit3,  gl_TexCoord[0].st );
	vec4 altitude = texture2D( src_tex_unit4,  gl_TexCoord[0].st );
  ...
  /**
    ...
    */
    scale3d = vec4 ( father_scale.x*altitude.r,
                   father_scale.y*altitude.g,
                   father_scale.z*altitude.b,
                   0.83 );

  } else {
	scale3d = vec4 (	altitude.r,
										altitude.g,
										altitude.b,
										0.83 );
/*
scale3d = vec4 (	father_scale.x*altitude.r,
									...
									father_scale.z*altitude.b,
									0.83 );
    scale3d = vec4 (	father_scale.x*0.618*altitude.r,
    									father_scale.y*0.618*altitude.g,
    									father_scale.z*0.618*altitude.b,
    									0.83 );
*/
  }
  return scale3d;
